...
import image1 from '../../assets/business/image1.webp';
import image2 from '../../assets/business/image2.webp';
import image3 from '../../assets/business/image3.webp';
import image4 from '../../assets/business/image4.webp';
     ...
     <div className="bg-white min-h-screen">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="max-w-4xl mx-auto text-center pt-32 pb-16">
          <h1 className="text-6xl font-light tracking-tight mb-6">Business Class</h1>
          <section className="text-2xl font-light leading-relaxed tracking-tight px-6 py-6">
            Travel to your next meeting, dinner or flight in optimal time and comfort with Business Class, featuring the latest Mercedes-Benz EQE and E-Class or BMW 5 Series, expertly driven by a Wheely chauffeur.
          </section>
        </div>
