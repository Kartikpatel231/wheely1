...
import image1 from '../../assets/Newbusiness/image1.webp';
import image2 from '../../assets/Newbusiness/image2.webp';
import image3 from '../../assets/Newbusiness/image3.webp';
import image4 from '../../assets/Newbusiness/image4.webp';
import image5 from '../../assets/Newbusiness/image5.webp';
import image6 from '../../assets/Newbusiness/image6.webp';
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex justify-center py-3">
          ...
          >
            <span className="whitespace-nowrap">Business Class:</span>
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="max-w-4xl mx-auto text-center pt-32 pb-16">
          <h1 className="text-6xl font-semibold tracking-tight mb-6 ">New Business Class</h1>
          <section className="text-2xl font-light leading-relaxed tracking-tight px-6 py-6">
            Experience the new generation of Business Class with the latest BMW 5 Series G60, streamlined to one consistent vehicle model. Travel to your next meeting, dinner or flight in optimal time and comfort.
          </section>
        </div>
