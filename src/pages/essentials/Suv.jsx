...
import image1 from '../../assets/Suv/image1.webp';
import image2 from '../../assets/Suv/image2.webp';
import image3 from '../../assets/Suv/image3.webp';
import image4 from '../../assets/Suv/image4.webp';
import image5 from '../../assets/Suv/image5.webp';
import image6 from '../../assets/Suv/image6.webp';
import image7 from '../../assets/Suv/image7.webp';
import image8 from '../../assets/Suv/image8.webp';
...
const Suv = () => {
  ...
  const galleryItems = [
    ...
    { src: image7, alt: 'Sunroof', title: 'Sunroof', description: 'In vehicles with a panoramic sunroof, enjoy extensive views.' },
    { src: image8, alt: 'Sunroof', title: 'Sunroof', description: 'In vehicles with a panoramic sunroof, enjoy extensive views.' },
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex justify-center py-3">
          ...
          >
            <span className="whitespace-nowrap">SUV:</span>
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="max-w-4xl mx-auto text-center pt-32 pb-16">
          <h1 className="text-6xl font-semibold tracking-tight mb-6 ">SUV</h1>
          <section className="text-2xl font-light leading-relaxed tracking-tight px-6 py-6">
            Exclusive to Members, experience Wheely’s most refined class to date, featuring the latest generation Range Rover Long Wheelbase 4x4. Enjoy a spacious cabin, ample luggage room, and thoughtful amenities. Whether in the city or countryside, SUV Class provides maximum comfort for any journey.
          </section>
        </div>
