...
import image1 from '../../assets/FirstClass/image1.webp';
import image2 from '../../assets/FirstClass/image2.webp';
import image3 from '../../assets/FirstClass/image3.webp';
import image4 from '../../assets/FirstClass/image4.webp';
import image5 from '../../assets/FirstClass/image5.webp';
import image6 from '../../assets/FirstClass/image6.webp';
import image7 from '../../assets/FirstClass/image7.webp';
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex justify-center py-3">
          ...
          >
            <span className="whitespace-nowrap">First Class:</span>
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="max-w-4xl mx-auto text-center pt-32 pb-16">
          <h1 className="text-6xl font-semibold tracking-tight mb-6 ">First Class</h1>
          <section className="text-2xl font-light leading-relaxed tracking-tight px-6 py-6">
           Experience unparalleled comfort and style with Wheely’s upgraded First Class, now available for all clients. Enjoy refined journeys in the latest ultra-spacious Mercedes-Benz W223 S-Class, meticulously designed for the smoothest travel experience.
          </section>
        </div>
