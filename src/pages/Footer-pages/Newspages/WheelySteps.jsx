...
const WheelySteps = () => {
  ...
  return (
    <div className="bg-white  ">
      <h2 className="text-2xl font-semibold  ml-75 mb-2">
        3 STEPS TO PARTNERING WITH WHEELY
      </h2>
      <p className=" text-gray-600 mb-10 ml-75 max-w-3xl ">
        We hire the best and respect their time. Newly-applying chauffeurs can be certified and driving within just 3 days.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ml-75 mr-75">
        {steps.map((step) => (
          <div key={step.number}>
